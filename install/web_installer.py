...
# Auto-generated by OpenAlgo Web Installer
...
# Market Data Configuration (XTS Brokers)
...
HOST_SERVER = 'https://{domain}' if '{domain}' else 'http://{diag["public_ip"]}:5000'
PUBLIC_URL = 'https://{domain}' if '{domain}' else 'http://{diag["public_ip"]}:5000'

# Remote MCP Settings
MCP_HTTP_ENABLED = '{str(enable_mcp)}'
MCP_PUBLIC_URL = 'https://{domain}/mcp' if '{domain}' else ''
