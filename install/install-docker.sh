...
is_xts_broker() {
    local broker=$1
    local xts_brokers="acagarwal,fivepaisaxts,compositedge,ibulls,iifl,jainamxts,rmoney,wisdom"
    [[ ",$xts_brokers," == *",$broker,"* ]]
}
...
while true; do
    log "\nValid brokers:" "$BLUE"
    echo "acagarwal, fivepaisa, fivepaisaxts, aliceblue, angel, arrow, compositedge, definedge, deltaexchange,"
