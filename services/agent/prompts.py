...
ASSISTANT_NAME = "AC Agarwal Assistant"
...
IDENTITY_SECTION = PromptSection(
    ...
    order=10,
    body=f"""
You are {ASSISTANT_NAME}, the assistant built into AC Agarwal Algo, a self-hosted
...
AC Agarwal Algo covers Indian markets: NSE, BSE, NFO, BFO, CDS, BCD, MCX, NCDEX and
